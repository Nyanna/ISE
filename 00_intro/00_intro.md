...
A central structural feature is the **inversion of the fundamental category of reality**: relation is treated as ontologically prior to substance.
...
A notable structural feature is **self-referential coherence**: the description is itself treated as an emergent product of the same differentiation process it postulates. The account does not claim a vantage point outside its subject matter but arises from within it.

ISE is not a theory in the classical sense but a shift in perspective: the dissolution of any static foundation in favor of a dynamic, scale-dependent reality. This founding of an entirely new category — **Scale-Relational Physics** — requires its own mathematical language: **Scale-Relational Mathematics (SRM)**, which treats ratios as primitive and scale transformations as fundamental, replacing absolute units with torsor structures.
...
A crucial insight: **coherence is not produced by differentiation but is the necessary precondition** that enables differentiation to occur through coherent division. Differentiation is simply relation itself — not a process that creates relations, but the ontological foundation from which all apparent structure emerges.
...
* **Time** is the sequential sampling of frequency profiles by a scale-bound observer — not an axis, but the serialization of differentiation. From this perspective, time dilation is sampling-rate dependence of differentiation serialization.
* **Mass** is the total bandwidth of a stable frequency profile — the depth of coherent structure across bands. In the SRM formalism, this is expressed as S-weight: dependency depth relative to the photon, which serves as the natural torsor origin — the simplest possible differentiation pattern.
* **Force** is the phase geometry between frequency bands at a given observational scale. Coupling constants are the precise arithmetic of phase transfer between bands as projected through our characteristic sampling rate. All four conventional forces reduce to two spectral primitives: inter-band phase structure and intra-band amplitude ratio.
...
This convergence follows from the setup rather than being imposed: the frequency-domain representation is derived as a consequence of treating differentiation as primitive, and within the scope developed here every physical concept maps onto a phase operation. Formalism and ontology coincide on this reading.

## **Key Concepts**

* **Infinite Expansion and Differentiation:** The universe is described as undergoing an ongoing expansion characterized by continuous differentiation of relational structure across scales. This differentiation is read as producing new states of reality, with structures and phenomena emerging dynamically. Space, time, and distance are treated as emergent projections of an underlying dependency structure rather than as pre-given backgrounds — a reading of the same phenomena standard accounts frame as intrinsic coordinates.

* **Protoinformation and the Frequency Domain:** A central concept of ISE is protoinformation, which represents an undifferentiated state that precedes both space and time — modeled as continuous white noise with infinite frequency content. Protoinformation is the ontological primitive from which all differentiated structures emerge. Differentiation operates as hierarchical sampling of this substrate: dimensionality emerges recursively, with one dimension creating scalar reference, two creating wave structure, and N dimensions creating observable physics. The frequency domain is identified as the natural representation because it directly encodes differentiation rate without privileging spatial or temporal coordinates. What we call "elementary particles" are phase-locked composites of frequencies extending arbitrarily deep — there is no bottom level.

* **Dependency Propagation and Unified Physics:** Later chapters develop a reading in which the fundamental physical quantities — time, mass, space, and gravitation — are treated as projective manifestations of a single underlying process: dependency propagation through differentiation structure. The speed of light *c* is read not as a velocity limit but as the irreducible rate of dependency update. Mass corresponds to dependency depth; time to the seriality of dependency chains; space to the relational structure of the dependency network; gravitation to interaction between dependency densities (S-weights). Under this reading, relativistic mechanics, quantum mechanics, and gravitation appear as scale-dependent projections of the same dependency architecture.

* **Cosmological Consequences — Rethinking Dark Energy and the Big Bang:** Dark energy is interpreted as an emergent feature of the differentiation process — a scale-dynamic interference effect arising from subquantum resonances in which destructive interference cancels most vacuum energy — so that its magnitude follows from the redistribution of relational structure across expanding scales. In the same reading, the Big Bang need not be treated as a singular origin event but as a localized differentiation event within an ongoing process, and the Cosmic Microwave Background is read as an imprint from differentiation processes at earlier evolutionary phases rather than necessarily a Big Bang relic.

* **Fractal Structure and Multiverse Implications:** The universe is read as exhibiting a fractal-like structure in which the same principles of differentiation recur at every scale, producing self-similar patterns across galactic formations and subatomic structures. A multiverse reading follows as speculation: each universe as a differentiated state within an infinite hierarchy — universes as elementary particles of larger scales, each particle potentially a universe at a smaller scale. Continuity between universes is rejected on this reading: each scale is self-contained, and probabilistic interpretations with parallel universes are incompatible with the framework, since only realized differentiations are counted as existing.

* **Emergent Space, Time, and Causality:** In the framework, space and time are emergent phenomena arising from differentiation. Causality is not an intrinsic feature of the universe but emerges from relational order within differentiated states — it is the geometric necessity of relational continuity under a given projection. Causality is scale-dependent and is shaped by the observer's frame of reference. At different levels of differentiation, the flow of time and the perception of causality can vary, resulting in non-linear dynamics that could explain phenomena like the early emergence of complex galaxies.

* **Reading Singularities as Scale Transitions:** Singularities — as posited in Big Bang and black hole models — are re-read as regions of intense differentiation rather than as points of collapse. Energy is described as undergoing smooth transitions across scales; black holes appear as regions where differentiation stalls for external observers while continuing internally, functioning as loci of scale transition rather than endpoints. The external frame registers a frozen collapse near the horizon while the intrinsic frame retains finite proper time and coherent local physics. Points that appear singular on one reading remain smooth on this one.

* **Quantum Effects and Macroscopic Manifestations:** Quantum effects are read as having macroscopic reach rather than being confined to the microscopic world, with their projection changing as energy differentiates. Quantum uncertainty is interpreted as a relational phenomenon arising from the interaction between system and observer — from the mismatch between continuous relational dynamics and discrete classical readout — rather than as an intrinsic property of nature. The Heisenberg uncertainty principle, on this reading, constrains the projection of continuous update interactions onto discrete eigenvalues rather than the interaction itself. The distinction between quantum and classical regimes then reduces to a matter of scale.

* **An Integrating Reading:** The reading developed here addresses cosmic evolution, the fundamental forces, and the character of physical reality within a single frame. In place of fixed spacetime and singular origin conditions, it offers a dynamic, evolving picture in which subatomic particles and large-scale cosmic structures are linked through a shared differentiation structure. The intent is integration rather than replacement: the resulting view reduces the reliance on unexplained starting conditions and extends the discussion to existence, causality, and the possibility of interconnected realities beyond current observation.

In summary, the reading treats space, time, and cosmic structure as emergent properties of continuous differentiation across scales. Protoinformation serves as the substrate from which observable phenomena arise, linking the quantum and cosmic regimes through the frequency domain. Dark energy is reinterpreted, singularities are read as scale transitions, and the universe is described as an evolving structure with fractal-like self-similarity. Treating time and causality as scale-dependent emergent properties is intended to provide an integrating view that connects quantum behaviour and large-scale cosmology within a single scale-relational account.
...
* This suggests that universes form as **scale-localized resonance phenomena** — resonance closures within a broader differentiation field — rather than absolute singular events.

On this reading, reality appears as a structured resonance field within a continuous differentiation process. The physical universe is treated **not as an isolated entity but as a dynamically emergent stability layer**, defined by the resonance closures achievable at our scale's characteristic sampling rate. The aim is to integrate quantum mechanics, cosmology, and high-energy phenomena within a single scale-relational structure.
